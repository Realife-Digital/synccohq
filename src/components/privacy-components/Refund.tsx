    ...
    <>
      <div className="space-y-4 text-justify">
        ...
        <p className="text-justify">
          ...
          solutions. However, due to the nature of software development, we have
        ...
        <ol className="list-decimal list-inside space-y-4 text-justify">
          ...
          <li>
            ...
            <p>
              {" "}
              Refunds (if applicable) will be calculated based on the proportion
              of work not delivered.
            </p>
          </li>
          <li>
